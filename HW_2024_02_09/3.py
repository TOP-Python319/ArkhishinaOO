...
# в 8-ой строке можно не ставить скобки, потому что приоритет у операции and выше, чем у операции or,
# но сам я обычно ставлю скобки, чтобы сразу было видно что точно выполнится первым